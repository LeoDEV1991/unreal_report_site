...
class DimOrganisation(Base):
    ...
    SafetyBankBalance = Column(Integer, nullable=False)
    ...
    FiscalYearStartMonth = Column(Integer, nullable=False)
    SafetyBankBalance = Column(Integer, nullable=False)
    Upper = Column(Numeric(precision=10, scale=2))
    Lower = Column(Numeric(precision=10, scale=2))
    def __repr__(self):
