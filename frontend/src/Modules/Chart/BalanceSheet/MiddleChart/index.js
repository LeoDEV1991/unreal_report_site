                      ...
                      <div className={`flex`}
                       style = {{
                        ...
                        <p
                          ...
                          style={formatedStyle(_w1 , 12,0,key==="Total Liabilities"?1:0 , 'pointer')} className={` grayHover `} id={"Colkey" + key} >
                          {key}
                        </p>
                        ...
                        {(() => {
                          ...
                          {
                            return(
                                <p style={formatedStyle(_w2 , 12,0,key==="Total Liabilities"?1:0)} align = "right" className={`grayHover`}>
                        ...
                        {(() => {
                          ...
                          if(collapsableData[key]["last"] === 1 || !this.state.opened)
                          {
                            ...
                            return(
                                <p style={formatedStyle(_w3, 12,0,key==="Total Liabilities"?1:0)} align = "right"  className={`grayHover`}>
                  ...
                  if(key != "opening" && key != "closing" && key != "last")
                  {
                      ...
                      style = {{
                        ...
                        <p
                          ...
                          style={formatedStyle(_w1 - 30 , 12,0,key=="Total Liabilities"?1:0 , 'pointer') } className={` grayHover `} id={"Colkey" + key} >
