                ...
                <Grid item md={"auto"} >
                     {data.map((d, i) => {
                            ...
                            if(d["IncomeStatementCategory"] === "Income")
                            {
                              ...
                              return (
                                  <div  className={i%2===1?`flex tableColor1`:`flex`} key = {i} style={{borderTop: `solid ${borderWidth}px #a9a9a9` , height:'20px' }}>
                                    ...
                                    <div style ={{borderRight: `solid 1px #a9a9a9`}}>
                            ...
                            if(d["PProfit"])
                            {
                              return (
                                  <div  className={i%2===1?`flex tableColor1`:`flex`} key = {i} >
                                    <div style={{borderBottom: `solid 1px #a9a9a9`}}>
                                      <p style={formatedStyle(cellwidth* 1/3 + 30, 11 , 0 , 1)} className={` grayHover tableColor2` }>
                                        % Profit
                                      </p>
                                    </div>
                                    <div style ={{borderRight: `solid 1px #a9a9a9`,borderBottom: `solid 1px #a9a9a9`}}>
                                      <p style={formatedStyle(cellwidth* 2/3  + 80, 11 , 0 , 1)} className={` grayHover`}>
                                        &nbsp;
                                      </p>
                                    </div>
