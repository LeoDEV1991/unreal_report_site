...
class BottomChart extends Component {
  ...
  _showTooltip = (event, xScale, bar, isBar=true) => {
    ...
    if (isBar) {
      ...
      top = event.pageY - topchartHeight - offset;
  ...
  render() {
    ...
    var { data, maxData , minData , showFilter , sortFilter} = this.state;
    ...
    return (
      ...
      <div className={classes.root}  id = "bottomRoot">
        ...
        <div className="well" style = {{minHeight:'200px',maxHeight:'450px',overflowY: 'auto' }}>
                        ...
                        <Grid container >
                          ...
                          <Grid item md={3} >
                            <div >
                              ...
                              <p>{thousandFormat2(tooltipData.bar.data.ActualHoursMTD)}</p>
                          ...
                          <Grid item md={3} >
                            <div >
                              ...
                              <p>{thousandFormat2(tooltipData.bar.data.ActualHoursYTD)}</p>
                          ...
                          <Grid item md={3} >
                            <div >
                              ...
                              <p>{thousandFormat2(tooltipData.bar.data.ActualHoursJTD)}</p>
