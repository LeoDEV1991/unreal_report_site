              ...
              >
                {tooltipData.isBar ?
                  <div>
                    ...
                    <div className="ft-12">
                      Actual: <strong>${thousandFormat(tooltipData.bar.data.value[tooltipData.key].ActualExpenses)}</strong>
                    </div>
                    <div className="ft-12">
                      Forecast: <strong>${thousandFormat(tooltipData.bar.data.value[tooltipData.key].ForecastExpenses)}</strong>
                    </div>
                  </div>
                  :
                  <div>
