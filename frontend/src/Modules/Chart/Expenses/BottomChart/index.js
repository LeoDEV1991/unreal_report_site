  ...
  render() {
    ...
    return (
      ...
      onTouchMove={event => this.handlePos(event)}>
        ...
        <div style={{overflowX:'hidden' ,maxHeight:`${height}px`, padding:'0px', borderTop: 'solid 1px #a9a9a9',
        borderLeft: 'solid 1px #a9a9a9',borderRight: 'solid 1px #a9a9a9'}}>
                ...
                return (
                  <Grid container key={i} >
                    <Grid item md={12} sm={12} xs={12}>
                      <Grid container >
                        <Grid item md={2} sm={2} xs={2} style={{ borderRight: 'solid 1px #a9a9a9'}}
                        {...{onClick: (event) => {
        ...
        <div  style={formatedStyle(xMax  , 12, 0 , 0)  ,{borderTop: 'solid 1px #a9a9a9', padding:'0px'}}  >
          <div >
              {data.length >0?
