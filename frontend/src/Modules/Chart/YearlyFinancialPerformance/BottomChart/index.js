          ...
          <div className="flex" >
            {
              ...
              {
                return(
                  <div key={i} style={{'width':(cellwidth * 2 + (i===0?headerWidth:0) )}} >
                    <Grid container>
          ...
          <div className="flex" >
            {
              selectedItems.map( (item , i) =>
              {
                ...
                return (
                  <div key = {parseInt(i) + 100} style={{borderTop: 'solid 1px #a9a9a9',borderRight: 'solid 1px #a9a9a9'}}>
                    {
                      // **************** Income Data *************************
                    ...
                    <div  className={classes.rows}
                      ...
                      <Grid container>
                        ...
                        <Grid item md={12} sm={12} xs={12}>
                          <div className="flex" align = "right"
                               style={{paddingRight:'5px', borderTop: 'solid 1px #a9a9a9', borderBottom: 'solid 1px #a9a9a9'}}>
                            {
                              i === 0 ?
                                <div className="flex" style={{borderRight: 'solid 1px #a9a9a9'}} align ='left'>
                                  <p style={formatedStyle(headerWidth , 11 , 0 , 1)} className={` grayHover`}>
