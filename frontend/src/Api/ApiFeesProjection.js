...
const ApiFeesProjection = () => {
  ...
  const getSummary = (selectedYears) => {
    ...
    return _api.get('v1.0/feesprojection/summary' + queryParams);
  };
  ...
  const getDetail = (selectedYears) => {
    ...
    queryParams += ('?filter=' + JSON.stringify(filter));
    return _api.get('v1.0/feesprojection/detail' + queryParams);
  };
...
export default ApiFeesProjection();
