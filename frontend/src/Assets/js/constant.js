...
const single_years = [2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021];
const daysRangeKeys = [
...
const minusActiveColor = '#be1e2d';
const minusDisableColor = '#e9cccf';
...
const formatedStyle = (width, size , mar = 0 , bolds = 0 , cursors = '') => {
  return {
    width: `${width}px`,
    fontSize: `${size}px`,
    fontFamily:'Verdana',
    margin: `${mar}`,
    paddingTop:'5px',
    fontWeight: `${bolds===1?'bold':'normal'}`,
    cursor:`${cursors}`,
  }
};

const subtitle_inv = {
  backgroundColor: '#e0ebd2'
};
